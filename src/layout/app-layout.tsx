...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Cart', path: '/carts', entity: 'cart', service: AccessServiceEnum.PROJECT, icon: FiShoppingCart },
    {
      name: 'Cart Item',
      path: '/cart-items',
      entity: 'cart_item',
    ...
    { name: 'Review', path: '/reviews', entity: 'review', service: AccessServiceEnum.PROJECT, icon: FiStar },
