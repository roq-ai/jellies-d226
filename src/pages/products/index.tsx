...
function ProductListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<ProductInterface[]>(
    ...
    () =>
      getProducts({
        relations: ['company', 'cart_item.count', 'review.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('cart_item', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>cart_item</Th>}
